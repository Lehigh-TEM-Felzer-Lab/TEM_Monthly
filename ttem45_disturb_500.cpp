...
//   ag.fertn = 15.0;
//   ag.fertn = 19.0;
if(pdyr < 210) { ag.fertn = 0.0; }
//if(pdyr < 209) { ag.fertn = 0.0; }
//if(pdyr >= 209 && pdyr <= 244) { ag.fertn = 1.0;}
//if(pdyr >= 245 && pdyr <= 257) { ag.fertn = 2.0;}
if(pdyr == 210) { ag.fertn = 0.51; }
if(pdyr == 211) { ag.fertn = 0.54; }
if(pdyr == 212) { ag.fertn = 0.56; }
if(pdyr == 213) { ag.fertn = 0.58; }
if(pdyr == 214) { ag.fertn = 0.59; }
if(pdyr == 215) { ag.fertn = 0.61; }
if(pdyr == 216) { ag.fertn = 0.62; }
if(pdyr == 217) { ag.fertn = 0.63; }
if(pdyr == 218) { ag.fertn = 0.65; }
if(pdyr == 219) { ag.fertn = 0.66; }
if(pdyr == 220) { ag.fertn = 0.67; }
if(pdyr == 221) { ag.fertn = 0.69; }
if(pdyr == 222) { ag.fertn = 0.70; }
if(pdyr == 223) { ag.fertn = 0.72; }
if(pdyr == 224) { ag.fertn = 0.72; }
if(pdyr == 225) { ag.fertn = 0.73; }
if(pdyr == 226) { ag.fertn = 0.75; }
if(pdyr == 227) { ag.fertn = 0.76; }
if(pdyr == 228) { ag.fertn = 0.77; }
if(pdyr == 229) { ag.fertn = 0.78; }
if(pdyr == 230) { ag.fertn = 0.79; }
if(pdyr == 231) { ag.fertn = 0.80; }
if(pdyr == 232) { ag.fertn = 0.81; }
if(pdyr == 233) { ag.fertn = 0.82; }
if(pdyr == 234) { ag.fertn = 0.84; }
if(pdyr == 235) { ag.fertn = 0.85; }
if(pdyr == 236) { ag.fertn = 0.86; }
if(pdyr == 237) { ag.fertn = 0.87; }
if(pdyr == 238) { ag.fertn = 0.94; }
if(pdyr == 239) { ag.fertn = 1.02; }
if(pdyr == 240) { ag.fertn = 1.09; }
if(pdyr == 241) { ag.fertn = 1.16; }
if(pdyr == 242) { ag.fertn = 1.24; }
if(pdyr == 243) { ag.fertn = 1.31; }
if(pdyr == 244) { ag.fertn = 1.38; }
if(pdyr == 245) { ag.fertn = 1.46; }
if(pdyr == 246) { ag.fertn = 1.53; }
if(pdyr == 247) { ag.fertn = 1.61; }
if(pdyr == 248) { ag.fertn = 1.68; }
if(pdyr == 249) { ag.fertn = 1.75; }
if(pdyr == 250) { ag.fertn = 1.83; }
if(pdyr == 251) { ag.fertn = 1.90; }
if(pdyr == 252) { ag.fertn = 1.97; }
if(pdyr == 253) { ag.fertn = 2.05; }
if(pdyr == 254) { ag.fertn = 2.12; }
if(pdyr == 255) { ag.fertn = 2.19; }
if(pdyr == 256) { ag.fertn = 2.27; }
if(pdyr == 257) { ag.fertn = 2.34; }
if(pdyr == 258) { ag.fertn = 2.94; }
if(pdyr == 259) { ag.fertn = 3.53; }
if(pdyr == 260) { ag.fertn = 4.13; }
if(pdyr == 261) { ag.fertn = 4.72; }
if(pdyr == 262) { ag.fertn = 5.32; }
if(pdyr == 263) { ag.fertn = 5.91; }
if(pdyr == 264) { ag.fertn = 6.51; }
if(pdyr == 265) { ag.fertn = 8.41; }
if(pdyr == 266) { ag.fertn = 9.65; }
if(pdyr == 267) { ag.fertn = 10.43; }
if(pdyr == 268) { ag.fertn = 11.67; }
if(pdyr == 269) { ag.fertn = 12.34; }
if(pdyr == 270) { ag.fertn = 12.56; }
if(pdyr == 271) { ag.fertn = 12.0; }
if(pdyr == 272) { ag.fertn = 12.9; }
if(pdyr == 273) { ag.fertn = 12.79; }
if(pdyr == 274) { ag.fertn = 11.55; }
if(pdyr == 275) { ag.fertn = 11.78; }
if(pdyr == 276) { ag.fertn = 14.25; }
if(pdyr == 277) { ag.fertn = 14.36; }
if(pdyr == 278) { ag.fertn = 14.13; }
if(pdyr == 279) { ag.fertn = 15.14; }
if(pdyr == 280) { ag.fertn = 14.58; }
if(pdyr == 281) { ag.fertn = 15.37; }
if(pdyr == 282) { ag.fertn = 15.14; }
if(pdyr == 283) { ag.fertn = 15.37; }
if(pdyr == 284) { ag.fertn = 15.48; }
if(pdyr == 285) { ag.fertn = 15.71; }
if(pdyr == 286) { ag.fertn = 14.81; }
if(pdyr == 287) { ag.fertn = 14.81; }
if(pdyr == 288) { ag.fertn = 15.37; }
if(pdyr == 289) { ag.fertn = 14.70; }
if(pdyr == 290) { ag.fertn = 14.81; }
if(pdyr == 291) { ag.fertn = 14.36; }
if(pdyr == 292) { ag.fertn = 14.25; }
if(pdyr == 293) { ag.fertn = 13.8; }
if(pdyr == 294) { ag.fertn = 14.47; }
if(pdyr == 295) { ag.fertn = 14.58; }
if(pdyr == 296) { ag.fertn = 14.92; }
if(pdyr == 297) { ag.fertn = 14.58; }
if(pdyr == 298) { ag.fertn = 14.92; }
if(pdyr == 299) { ag.fertn = 14.92; }
if(pdyr == 300) { ag.fertn = 15.26; }
if(pdyr == 301) { ag.fertn = 14.29; }
if(pdyr == 302) { ag.fertn = 15.37; }
if(pdyr == 303) { ag.fertn = 15.26; }
if(pdyr == 304) { ag.fertn = 15.37; }
if(pdyr == 305) { ag.fertn = 15.48; }
if(pdyr == 306) { ag.fertn = 15.53; }
if(pdyr == 307) { ag.fertn = 15.57; }
if(pdyr == 308) { ag.fertn = 15.62; }
if(pdyr == 309) { ag.fertn = 15.66; }
if(pdyr == 310) { ag.fertn = 15.71; }
if(pdyr == 311) { ag.fertn = 15.71; } 
  }
...
//  cout << "leafc = " << pdstate[I_LEAFC] << " " << veg.getALLOCLC() << " " << veg.getRMLEAF() << " " << veg.getLTRLC() << endl;
...
//cout << "time = " << pdyr << " " << pdm << " " << ag.state << " " << ag.fertn << endl;
