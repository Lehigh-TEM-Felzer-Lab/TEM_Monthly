...
void Ttem45::massbal(void)
{
  ...
  if ((y[I_SM] - prevy[I_SM]) != (soil.getSNOWINF() + atms.getRAIN() + y[I_AGIRRIG] - y[I_RPERC] - y[I_EET] - y[I_SPERC]))
  {
    y[I_SPERC] = soil.getSNOWINF() + atms.getRAIN() + y[I_AGIRRIG] - y[I_RPERC] - y[I_EET] - y[I_SM] + prevy[I_SM];
  }
  ...
  if (y[I_LEAFC] - prevy[I_LEAFC] != y[I_ALLOCLC] - y[I_RMLEAF] - y[I_LTRLC])
  {
  ...
  if (y[I_SAPWOODC] - prevy[I_SAPWOODC] != y[I_ALLOCSC] - y[I_ALLOCHC] - y[I_RMSAPWOOD] - y[I_LTRSC])
  {
  ...
  if (y[I_HEARTWOODC] - prevy[I_HEARTWOODC] != y[I_ALLOCHC] - y[I_LTRHC])
  {
  ...
  if (y[I_ROOTC] - prevy[I_ROOTC] != y[I_ALLOCRC] - y[I_RMROOT] - y[I_LTRRC])
  {
  ...
  if (y[I_SEEDC] - prevy[I_SEEDC] != y[I_ALLOCSEEDC] - y[I_RMSEED] - y[I_LTRSEEDC])
  {
    y[I_LTRSEEDC] = y[I_ALLOCSEEDC] - y[I_RMSEED] - y[I_SEEDC] + prevy[I_SEEDC];
  }

  if (y[I_LABILEC] - prevy[I_LABILEC] != y[I_GPP] - y[I_ALLOCLC] - y[I_ALLOCSC] - y[I_ALLOCRC] -
                                             -y[I_ALLOCSEEDC] - y[I_RVGRW])
  {
    y[I_RVGRW] = y[I_GPP] - y[I_ALLOCLC] - y[I_ALLOCSC] - y[I_ALLOCRC] - y[I_ALLOCSEEDC] - y[I_LABILEC] + prevy[I_LABILEC];
  }
  ...
  if (y[I_SOLC] - prevy[I_SOLC] != y[I_LTRLC] + y[I_LTRSC] + y[I_LTRHC] + y[I_LTRRC] + y[I_LTRSEEDC] + ag.getSLASHC() - ag.getSCONVRTFLXC() - y[I_RH] - y[I_DOCPROD])
  {
    y[I_RH] = y[I_LTRLC] + y[I_LTRSC] + y[I_LTRHC] + y[I_LTRRC] + y[I_LTRSEEDC] + ag.getSLASHC() - ag.getSCONVRTFLXC() - y[I_DOCPROD] - y[I_SOLC] + prevy[I_SOLC];
  }
  ...
  if (y[I_LABILEN] - prevy[I_LABILEN] != y[I_VNUP] + y[I_NRESORBL] + y[I_NRESORBS] + y[I_NRESORBR] + y[I_NRESORBSEED] + y[I_NFIXS] - y[I_ALLOCLN] - y[I_ALLOCSN] - y[I_ALLOCRN] - y[I_ALLOCSEEDN])
  {
    y[I_NRESORBL] = y[I_ALLOCLN] + y[I_ALLOCSN] + y[I_ALLOCRN] + y[I_ALLOCSEEDN] + y[I_NFIXS] - y[I_VNUP] + y[I_LABILEN] - prevy[I_LABILEN] - y[I_NRESORBS] - y[I_NRESORBR] - y[I_NRESORBSEED];
  }
  ...
  if (y[I_NRESORBL] < ZERO)
  {
    y[I_NRESORBL] = ZERO;
  }

  if (y[I_LEAFN] - prevy[I_LEAFN] != y[I_ALLOCLN] - y[I_NRESORBL] - y[I_LTRLN])
  {
  ...
  if (y[I_SAPWOODN] - prevy[I_SAPWOODN] != y[I_ALLOCSN] - y[I_ALLOCHN] - y[I_NRESORBS] - y[I_LTRSN])
  {
  ...
  if (y[I_HEARTWOODN] - prevy[I_HEARTWOODN] != y[I_ALLOCHN] - y[I_LTRHN])
  {
  ...
  if (y[I_SEEDN] - prevy[I_SEEDN] != y[I_ALLOCSEEDN] - y[I_NRESORBSEED] - y[I_LTRSEEDN])
  {
...
#ifdef OPENN
  if (y[I_SOLN] - prevy[I_SOLN] != y[I_LTRLN] + y[I_LTRSN] + y[I_LTRHN] + y[I_LTRRN] + y[I_LTRSEEDN] + ag.getSLASHN() + y[I_NFIXN] - y[I_DONPROD] - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_NMIN])
  {
    y[I_NMIN] = y[I_LTRLN] + y[I_LTRSN] + y[I_LTRHN] + y[I_LTRRN] + y[I_LTRSEEDN] + ag.getSLASHN() + y[I_NFIXN] - y[I_DONPROD] - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_SOLN] + prevy[I_SOLN];
  }
...
#else
  if (y[I_SOLN] - prevy[I_SOLN] != y[I_LTRLN] + y[I_LTRSN] + y[I_LTRHN] + y[I_LTRRN] + y[I_LTRSEEDN] + ag.getSLASHN() - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_NMIN])
  {
    y[I_NMIN] = y[I_LTRLN] + y[I_LTRSN] + y[I_LTRHN] + y[I_LTRRN] + y[I_LTRSEEDN] + ag.getSLASHN() - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_SOLN] + prevy[I_SOLN];
  }
  ...
  {
    //    y[I_NLST] = ZERO;
    y[I_NINP] = y[I_NLST] - y[I_NMIN] - ag.getVOLAN() + y[I_VNUP] + y[I_AVLN] - prevy[I_AVLN];
  }
  ...
  {
    //    y[I_NINP] = ZERO;
    y[I_NLST] = y[I_NINP] + y[I_NMIN] + ag.getVOLAN() - y[I_VNUP] - y[I_AVLN] + prevy[I_AVLN];
  }
};
  ...
  if (0 == pdm)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          microbe.setKD((ag.getKD() * y[I_SOLC] / ag.getNATSOIL()));
        }
        else
        {
...
//   soil.setNINPUT( ( ag.fertn) );
  ...
  ag.setTOTEC((veg.getVEGC() + y[I_SOLC]));
...
// NOTINSHREE
  ...
  mdemandn = y[I_ALLOCLN] + y[I_ALLOCSN] + y[I_ALLOCRN] + y[I_ALLOCSEEDN] - y[I_NRESORBL] - y[I_NRESORBS] - y[I_NRESORBR] - y[I_NRESORBSEED];
  ...
  if ((CYCLE - 1) == pdm)
  {
    ...
    if (1 == baseline)
    {
      ...
      if ((soil.yrorgc / microbe.getCNSOIL(veg.cmnt) > soil.yrorgn) && (y[I_SOLC] / microbe.getCNSOIL(veg.cmnt) > y[I_SOLN]))
      {
        soil.yrnin = (soil.yrorgc / microbe.getCNSOIL(veg.cmnt)) - soil.yrorgn;
        soil.yrnin += (y[I_SOLC] / microbe.getCNSOIL(veg.cmnt)) - y[I_SOLN];
        soil.yrnin /= 2.0;
      }
      else if ((soil.yrorgc / microbe.getCNSOIL(veg.cmnt) < soil.yrorgn) && (y[I_SOLC] / microbe.getCNSOIL(veg.cmnt) < y[I_SOLN]))
      {
  ...
  if (pdyr >= nyears + strteq)
  {
    ...
    if (0 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
        ...
        && (ctol >= fabs((veg.getVEGC() + y[I_SOLC]) -
                         (vegceq + soilceq))) &&
        (ctol >= fabs((veg.getVEGC() - vegceq))) && (ctol >= fabs((y[I_SOLC] - soilceq))))
    {
      return 1;
    }
    ...
    if (ag.state == 0)
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ntol >= fabs(soil.yrnin - soil.yrnlost)) && (ntol >= fabs((veg.getVEGN() + y[I_SOLN]) - (vegneq + soilneq))) && (ntol >= fabs((veg.getVEGN() - vegneq))) && (ntol >= fabs((y[I_SOLN] - soilneq)))
    ...
    else if (ag.state == 1)
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ntol >= (veg.getVEGN() + y[I_SOLN]) -
                          (vegneq + soilneq)) &&
          (ntol >= (veg.getVEGN() - vegneq)) && (ntol >= (y[I_SOLN] - soilneq))

          && (ctol >= (veg.getVEGC() + y[I_SOLC]) -
                          (vegceq + soilceq)) &&
          (ctol >= (veg.getVEGC() - vegceq)) && (ctol >= (y[I_SOLC] - soilceq)) && (fabs(yrnep - ag.yrformPROD1C) <= 2.0))
    ...
    else
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ctol >= (veg.getVEGC() + y[I_SOLC]) -
                          (vegceq + soilceq)) &&
          (ctol >= (veg.getVEGC() - vegceq)) && (ctol >= (y[I_SOLC] - soilceq)))
