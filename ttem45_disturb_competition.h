/* *************************************************************
****************************************************************
TTEM45_disturb.H - Terrestrial Ecosystem Model Version 4.5
****************************************************************
...
#ifndef TTEM45_DISURB_H
#define TTEM45_DISTURB_H
...
************************************************************** */
     ...
     void updateYearSummary( const int& pdm, const int& ichrt );
    ...
    //
     ...
     inline double getPREVY( const int& i, const int& j ) { return prevy[i][j]; }

     inline void setPREVY( const double& pprevy, const int& i, const int& j )
     {
       prevy[i][j] = pprevy;
     }
...
//   Vegetation Parameters
   ...
   seedcb[pcmnt] = pseedcb;
     ...
     inline double getY( const int& i, const int& j ) { return y[i][j]; }

     inline void setY( const double& py, const int& i, const int& j )
     {
       y[i][j] = py;
     }
...
************************************************************** */
     ...
     void resetODEflux( const int& pichrt );
