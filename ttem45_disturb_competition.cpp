                  ...
                  const double &nmax_grow)
{
  ...
  {
    dz1[i] = ZERO;
  } // reset dz1 if starting a new month
  for (i = 0; i < numeq; ++i)
  {
    dz4[i] = 1.0;
  } // reset dz4 if starting a new month
    ...
    if (1 == syint)
    {
      while (test != ACCEPT)
      {
        ...
        if (ACCEPT == test)
        {
          ...
          {
            dt = 1.0 - time;
          } // ensure that last step doesn't go over the end time
        }
        else
        {
          dt *= 0.500;
...
void Ttem45::cropDynamics(const int &pdm, const int &pdyr, const double &nmax_grow, double pstate[])
{
  ...
  if ((ag.fert1950flag == 1) && (ag.state == 1 || ag.state == 3) && pdm == 4)
  {
    ...
    if (startyr + pdyr == 1911)
    {
      ag.fertn = 0.54;
    }
    if (startyr + pdyr == 1912)
    {
      ag.fertn = 0.56;
    }
    if (startyr + pdyr == 1913)
    {
      ag.fertn = 0.58;
    }
    if (startyr + pdyr == 1914)
    {
      ag.fertn = 0.59;
    }
    if (startyr + pdyr == 1915)
    {
      ag.fertn = 0.61;
    }
    if (startyr + pdyr == 1916)
    {
      ag.fertn = 0.62;
    }
    if (startyr + pdyr == 1917)
    {
      ag.fertn = 0.63;
    }
    if (startyr + pdyr == 1918)
    {
      ag.fertn = 0.65;
    }
    if (startyr + pdyr == 1919)
    {
      ag.fertn = 0.66;
    }
    if (startyr + pdyr == 1920)
    {
      ag.fertn = 0.67;
    }
    if (startyr + pdyr == 1921)
    {
      ag.fertn = 0.69;
    }
    if (startyr + pdyr == 1922)
    {
      ag.fertn = 0.70;
    }
    if (startyr + pdyr == 1923)
    {
      ag.fertn = 0.72;
    }
    if (startyr + pdyr == 1924)
    {
      ag.fertn = 0.72;
    }
    if (startyr + pdyr == 1925)
    {
      ag.fertn = 0.73;
    }
    if (startyr + pdyr == 1926)
    {
      ag.fertn = 0.75;
    }
    if (startyr + pdyr == 1927)
    {
      ag.fertn = 0.76;
    }
    if (startyr + pdyr == 1928)
    {
      ag.fertn = 0.77;
    }
    if (startyr + pdyr == 1929)
    {
      ag.fertn = 0.78;
    }
    if (startyr + pdyr == 1930)
    {
      ag.fertn = 0.79;
    }
    if (startyr + pdyr == 1931)
    {
      ag.fertn = 0.80;
    }
    if (startyr + pdyr == 1932)
    {
      ag.fertn = 0.81;
    }
    if (startyr + pdyr == 1933)
    {
      ag.fertn = 0.82;
    }
    if (startyr + pdyr == 1934)
    {
      ag.fertn = 0.84;
    }
    if (startyr + pdyr == 1935)
    {
      ag.fertn = 0.85;
    }
    if (startyr + pdyr == 1936)
    {
      ag.fertn = 0.86;
    }
    if (startyr + pdyr == 1937)
    {
      ag.fertn = 0.87;
    }
    if (startyr + pdyr == 1938)
    {
      ag.fertn = 0.94;
    }
    if (startyr + pdyr == 1939)
    {
      ag.fertn = 1.02;
    }
    if (startyr + pdyr == 1940)
    {
      ag.fertn = 1.09;
    }
    if (startyr + pdyr == 1941)
    {
      ag.fertn = 1.16;
    }
    if (startyr + pdyr == 1942)
    {
      ag.fertn = 1.24;
    }
    if (startyr + pdyr == 1943)
    {
      ag.fertn = 1.31;
    }
    if (startyr + pdyr == 1944)
    {
      ag.fertn = 1.38;
    }
    if (startyr + pdyr == 1945)
    {
      ag.fertn = 1.46;
    }
    if (startyr + pdyr == 1946)
    {
      ag.fertn = 1.53;
    }
    if (startyr + pdyr == 1947)
    {
      ag.fertn = 1.61;
    }
    if (startyr + pdyr == 1948)
    {
      ag.fertn = 1.68;
    }
    if (startyr + pdyr == 1949)
    {
      ag.fertn = 1.75;
    }
    ...
    if (startyr + pdyr == 1951)
    {
      ag.fertn = 1.90;
    }
    if (startyr + pdyr == 1952)
    {
      ag.fertn = 1.97;
    }
    if (startyr + pdyr == 1953)
    {
      ag.fertn = 2.05;
    }
    if (startyr + pdyr == 1954)
    {
      ag.fertn = 2.12;
    }
    if (startyr + pdyr == 1955)
    {
      ag.fertn = 2.19;
    }
    if (startyr + pdyr == 1956)
    {
      ag.fertn = 2.27;
    }
    if (startyr + pdyr == 1957)
    {
      ag.fertn = 2.34;
    }
    if (startyr + pdyr == 1958)
    {
      ag.fertn = 2.94;
    }
    if (startyr + pdyr == 1959)
    {
      ag.fertn = 3.53;
    }
    if (startyr + pdyr == 1960)
    {
      ag.fertn = 4.13;
    }
    if (startyr + pdyr == 1961)
    {
      ag.fertn = 4.72;
    }
    if (startyr + pdyr == 1962)
    {
      ag.fertn = 5.32;
    }
    if (startyr + pdyr == 1963)
    {
      ag.fertn = 5.91;
    }
    if (startyr + pdyr == 1964)
    {
      ag.fertn = 6.51;
    }
    if (startyr + pdyr == 1965)
    {
      ag.fertn = 8.41;
    }
    if (startyr + pdyr == 1966)
    {
      ag.fertn = 9.65;
    }
    if (startyr + pdyr == 1967)
    {
      ag.fertn = 10.43;
    }
    if (startyr + pdyr == 1968)
    {
      ag.fertn = 11.67;
    }
    if (startyr + pdyr == 1969)
    {
      ag.fertn = 12.34;
    }
    if (startyr + pdyr == 1970)
    {
      ag.fertn = 12.56;
    }
    if (startyr + pdyr == 1971)
    {
      ag.fertn = 12.0;
    }
    if (startyr + pdyr == 1972)
    {
      ag.fertn = 12.9;
    }
    if (startyr + pdyr == 1973)
    {
      ag.fertn = 12.79;
    }
    if (startyr + pdyr == 1974)
    {
      ag.fertn = 11.55;
    }
    if (startyr + pdyr == 1975)
    {
      ag.fertn = 11.78;
    }
    if (startyr + pdyr == 1976)
    {
      ag.fertn = 14.25;
    }
    if (startyr + pdyr == 1977)
    {
      ag.fertn = 14.36;
    }
    if (startyr + pdyr == 1978)
    {
      ag.fertn = 14.13;
    }
    if (startyr + pdyr == 1979)
    {
      ag.fertn = 15.14;
    }
    if (startyr + pdyr == 1980)
    {
      ag.fertn = 14.58;
    }
    if (startyr + pdyr == 1981)
    {
      ag.fertn = 15.37;
    }
    if (startyr + pdyr == 1982)
    {
      ag.fertn = 15.14;
    }
    if (startyr + pdyr == 1983)
    {
      ag.fertn = 15.37;
    }
    if (startyr + pdyr == 1984)
    {
      ag.fertn = 15.48;
    }
    if (startyr + pdyr == 1985)
    {
      ag.fertn = 15.71;
    }
    if (startyr + pdyr == 1986)
    {
      ag.fertn = 14.81;
    }
    if (startyr + pdyr == 1987)
    {
      ag.fertn = 14.81;
    }
    if (startyr + pdyr == 1988)
    {
      ag.fertn = 15.37;
    }
    if (startyr + pdyr == 1989)
    {
      ag.fertn = 14.70;
    }
    if (startyr + pdyr == 1990)
    {
      ag.fertn = 14.81;
    }
    if (startyr + pdyr == 1991)
    {
      ag.fertn = 14.36;
    }
    if (startyr + pdyr == 1992)
    {
      ag.fertn = 14.25;
    }
    if (startyr + pdyr == 1993)
    {
      ag.fertn = 13.8;
    }
    if (startyr + pdyr == 1994)
    {
      ag.fertn = 14.47;
    }
    if (startyr + pdyr == 1995)
    {
      ag.fertn = 14.58;
    }
    if (startyr + pdyr == 1996)
    {
      ag.fertn = 14.92;
    }
    if (startyr + pdyr == 1997)
    {
      ag.fertn = 14.58;
    }
    if (startyr + pdyr == 1998)
    {
      ag.fertn = 14.92;
    }
    if (startyr + pdyr == 1999)
    {
      ag.fertn = 14.92;
    }
    if (startyr + pdyr == 2000)
    {
      ag.fertn = 15.26;
    }
    if (startyr + pdyr == 2001)
    {
      ag.fertn = 14.29;
    }
    if (startyr + pdyr == 2002)
    {
      ag.fertn = 15.37;
    }
    if (startyr + pdyr == 2003)
    {
      ag.fertn = 15.26;
    }
    if (startyr + pdyr == 2004)
    {
      ag.fertn = 15.37;
    }
    if (startyr + pdyr == 2005)
    {
      ag.fertn = 15.48;
    }
    if (startyr + pdyr == 2006)
    {
      ag.fertn = 15.53;
    }
    if (startyr + pdyr == 2007)
    {
      ag.fertn = 15.57;
    }
    if (startyr + pdyr == 2008)
    {
      ag.fertn = 15.62;
    }
    if (startyr + pdyr == 2009)
    {
      ag.fertn = 15.66;
    }
    if (startyr + pdyr == 2010)
    {
      ag.fertn = 15.71;
    }
    if (startyr + pdyr == 2011)
    {
      ag.fertn = 15.71;
    }
    // if(startyr+pdyr < 1950)
  ...
  if ((ag.getGROWDD() >= ag.getGDDSEED(ag.cmnt)) || (1 == ag.getISPERENNIAL(ag.cmnt)))
  ...
  if (1 == avlnflag)
  {
    ...
    {
      soil.setNLOST((pstate[I_AVLN] - veg.getNUPTAKE() + microbe.getNETNMIN() + soil.getNINPUT()));
    }
    if (soil.getNLOST() < ZERO)
    {
      soil.setNLOST(ZERO);

      microbe.setNETNMIN((soil.getNLOST() + veg.getNUPTAKE() - soil.getNINPUT() - pstate[I_AVLN]));
    }
  }
  else
  {
    ...
    soil.setNLOST((soil.getNINPUT() + microbe.getNETNMIN() - veg.getNUPTAKE()));
  }
};
                   ...
                   double pdstate[])
{
  ...
  pdstate[I_LEAFC] = veg.getALLOCLC() - veg.getRMLEAF() - veg.getLTRLC();

  //  cout << "leafc = " << pdstate[I_LEAFC] << " " << veg.getALLOCLC() << " " << veg.getRMLEAF() << " " << veg.getLTRLC() << " " << veg.getLEAFC() << " " << pstate[0] << endl;
  pdstate[I_SAPWOODC] = veg.getALLOCSC() - veg.getALLOCHC() - veg.getRMSAPWOOD() - veg.getLTRSC();

  pdstate[I_HEARTWOODC] = veg.getALLOCHC() - veg.getLTRHC();

  pdstate[I_ROOTC] = veg.getALLOCRC() - veg.getRMROOT() - veg.getLTRRC();

  pdstate[I_SEEDC] = veg.getALLOCSEEDC() - veg.getRMSEED() - veg.getLTRSEEDC();

  pdstate[I_LABILEC] = veg.getGPP() - veg.getALLOCLC() - veg.getALLOCSC() - veg.getALLOCRC() - veg.getALLOCSEEDC() - veg.getRGRWTH();
  ...
  pdstate[I_SOLC] = veg.getLTRLC()
                    ...
                    + veg.getLTRSC() + veg.getLTRHC() + veg.getLTRRC() + veg.getLTRSEEDC() + ag.getSLASHC()
                    //                    + 0.865 * ag.getSLASHC()
                    - ag.getSCONVRTFLXC() - microbe.getDOCPROD() - microbe.getRH();
  //  ag.setSLASHC(0.0);
  ...
  pdstate[I_LEAFN] = veg.getALLOCLN() - veg.getNRESORBL() - veg.getLTRLN();

  pdstate[I_SAPWOODN] = veg.getALLOCSN() - veg.getALLOCHN() - veg.getNRESORBS() - veg.getLTRSN();

  pdstate[I_HEARTWOODN] = veg.getALLOCHN() - veg.getLTRHN();

  pdstate[I_ROOTN] = veg.getALLOCRN()
                     //                   + veg.getVEGNINP()
                     - veg.getNRESORBR() - veg.getLTRRN();

  //  cout << "pdstate = " << pdstate[I_ROOTN] << " " << veg.getALLOCRN() << " " << veg.getNRESORBR() << " " << veg.getLTRRN() << " " << y[I_ROOTN] << endl;

  pdstate[I_SEEDN] = veg.getALLOCSEEDN() - veg.getNRESORBSEED() - veg.getLTRSEEDN();
  ...
  pdstate[I_SOLN] = veg.getLTRLN()
                    ...
                    //                    + 0.865 * ag.getSLASHN()
                    + veg.getLTRSN() + veg.getLTRHN() + veg.getLTRRN() + veg.getLTRSEEDN() + ag.getSLASHN() + soil.getSONINP() - microbe.getDONPROD() - ag.getSCONVRTFLXN() - ag.getNSRETENT() - microbe.getNETNMIN();
  ...
  pdstate[I_LABILEN] = veg.getNUPTAKE() + veg.getVEGNINP() - veg.getALLOCLN() - veg.getALLOCSN() - veg.getALLOCRN() - veg.getALLOCSEEDN() + veg.getNRESORBL() + veg.getNRESORBS() + veg.getNRESORBR() + veg.getNRESORBSEED();
...
#else
  pdstate[I_SOLN] = veg.getLTRLN() + veg.getLTRSN() + veg.getLTRHN() + veg.getLTRRN() + veg.getLTRSEEDN() + ag.getSLASHN() - ag.getSCONVRTFLXN() - ag.getNSRETENT() - microbe.getNETNMIN();

  pdstate[I_LABILEN] = veg.getNUPTAKE() - veg.getALLOCLN() - veg.getALLOCSN() - veg.getALLOCRN() - veg.getALLOCSEEDN() + veg.getNRESORBL() + veg.getNRESORBS() + veg.getNRESORBR() + veg.getNRESORBSEED();

#endif

  pdstate[I_AVLN] = soil.getNINPUT() + microbe.getNETNMIN() + ag.getVOLAN()
                    //                    + veg.getVEGNINP()
                    - veg.getNUPTAKE() - soil.getNLOST();
  ...
  //  else
  //  {
  pdstate[I_SM] = soil.getSNOWINF() + atms.getRAIN() + ag.irrigate - soil.getEET() - soil.getRPERC() - soil.getSPERC();
  //  }
  ...
  pdstate[I_RVMNT] = veg.getRMLEAF() + veg.getRMSAPWOOD() + veg.getRMROOT() + veg.getRMSEED();
...
int Ttem45::ecdqc(const int &dcmnt)
{
  ...
  if (leafcb[dcmnt] <= -9999.99)
  {
    return qc = 102;
  }

  if (sapwoodcb[dcmnt] <= -9999.99)
  {
    return qc = 104;
  }

  if (heartwoodcb[dcmnt] <= -9999.99)
  {
    return qc = 106;
  }

  if (rootcb[dcmnt] <= -9999.99)
  {
    return qc = 108;
  }

  if (seedcb[dcmnt] <= -9999.99)
  {
    return qc = 110;
  }

  if (labilecb[dcmnt] <= -9999.99)
  {
    return qc = 112;
  }

  if (leafnb[dcmnt] <= -9999.99)
  {
    return qc = 114;
  }

  if (sapwoodnb[dcmnt] <= -9999.99)
  {
    return qc = 116;
  }

  if (heartwoodnb[dcmnt] <= -9999.99)
  {
    return qc = 118;
  }

  if (rootnb[dcmnt] <= -9999.99)
  {
    return qc = 120;
  }

  if (seednb[dcmnt] <= -9999.99)
  {
    return qc = 122;
  }

  if (labilenb[dcmnt] <= -9999.99)
  {
    return qc = 124;
  }

  if (solcb[dcmnt] <= -9999.99)
  {
    return qc = 126;
  }

  if (solnb[dcmnt] <= -9999.99)
  {
    return qc = 128;
  }

  if (avlnb[dcmnt] <= -9999.99)
  {
    return qc = 130;
  }

  if (veg.getCMAX1B(dcmnt) <= -9999.99)
  {
    return qc = 135;
  }
  if (veg.getTAULEAF(dcmnt) <= -99.99)
  {
    return qc = 138;
  }
  if (veg.getTAUSAPWOOD(dcmnt) <= -99.99)
  {
    return qc = 139;
  }
  if (veg.getTAUHEARTWOOD(dcmnt) <= -99.99)
  {
    return qc = 140;
  }
  if (veg.getTAUROOT(dcmnt) <= -99.99)
  {
    return qc = 141;
  }
  if (veg.getTAUSEED(dcmnt) <= -99.99)
  {
    return qc = 142;
  }

  if (veg.getKRA(dcmnt) <= -99.99)
  {
    return qc = 143;
  }

  if (microbe.getKDB(dcmnt) <= -99.99)
  {
    return qc = 146;
  }

  if (microbe.getLCCLNC(dcmnt) <= -99.99)
  {
    return qc = 147;
  }
  if (microbe.getPROPFTOS(dcmnt) <= -99.99)
  {
    return qc = 148;
  }

  if (veg.getNMAX1B(dcmnt) <= -9999.99)
  {
    return qc = 153;
  }

  if (microbe.getNUPB(dcmnt) <= -9999.99)
  {
    return qc = 157;
  }

  if (soil.getNLOSS(dcmnt) <= -99.99)
  {
    return qc = 158;
  }

  if (soil.getDENITR(dcmnt) <= -99.99)
  {
    return qc = 159;
  }

  if (veg.getCNLTR(dcmnt) <= -99.99)
  {
    return qc = 164;
  }

  if (microbe.getCNSOIL(dcmnt) <= -9999.99)
  {
    return qc = 165;
  }

  if (veg.getO3PARA(dcmnt) <= -99.99)
  {
    return qc = 193;
  }
  if (veg.getO3PARB(dcmnt) <= -99.99)
  {
    return qc = 194;
  }
  if (veg.getO3PARC(dcmnt) <= -99.99)
  {
    return qc = 195;
  }
                            ...
                            const double &psiplusc)
{
  ...
  for (int i = 0; i < MAXCHRTS; i++)
  {
    ...
    if (y[I_HEARTWOODC][i] < ZERO)
    {
      y[I_HEARTWOODC][i] = ZERO;
    }
    ...
    if (y[I_HEARTWOODN][i] < ZERO)
    {
      y[I_HEARTWOODN][i] = ZERO;
    }
...
void Ttem45::getenviron(void)
{
  ...
  soil.setSNOWPACK((soil.getPREVSPACK() + atms.getSNOWFALL() - soil.getSNOWINF()));
...
double Ttem45::getOptionalEflx(const int &optflx)
{
  ...
  case GET_LEAFC:
    ...
    break;
  case GET_SAPWOODC:
    outflux = y[I_SAPWOODC];
    break;
  case GET_HEARTWOODC:
    outflux = y[I_HEARTWOODC];
    break;
  case GET_ROOTC:
    outflux = y[I_ROOTC];
    break;
  ...
  case GET_LEAFN:
    ...
    break;
  case GET_SAPWOODN:
    outflux = y[I_SAPWOODN];
    break;
  case GET_HEARTWOODN:
    outflux = y[I_HEARTWOODN];
    break;
  case GET_ROOTN:
    outflux = y[I_ROOTN];
    break;
  ...
  case GET_ALLOCRC:
    ...
    break;
  case GET_ALLOCSEEDC:
    outflux = y[I_ALLOCSEEDC];
    break;
  case GET_ALLOCILC:
    outflux = y[I_ALLOCILC];
    break;
  case GET_ALLOCISC:
    outflux = y[I_ALLOCISC];
    break;
  case GET_ALLOCIHC:
    outflux = y[I_ALLOCIHC];
    break;
  case GET_ALLOCIRC:
    outflux = y[I_ALLOCIRC];
    break;
  case GET_ALLOCISEEDC:
    outflux = y[I_ALLOCISEEDC];
    break;
  case GET_INGPP:
    outflux = y[I_INGPP];
    break;
  ...
  case GET_D40:
    outflux = atms.getAOT40();
    break;
  case GET_NDEP:
    outflux = atms.getNDEP();
    break;
  case GET_FOZONE:
    outflux = y[I_FOZONE];
    break;
  ...
  case GET_ALLOCRN:
    ...
    break;
  case GET_ALLOCSEEDN:
    outflux = y[I_ALLOCSEEDN];
    break;
  case GET_ALLOCILN:
    outflux = y[I_ALLOCILN];
    break;
  case GET_ALLOCISN:
    outflux = y[I_ALLOCISN];
    break;
  case GET_ALLOCIHN:
    outflux = y[I_ALLOCIHN];
    break;
  case GET_ALLOCIRN:
    outflux = y[I_ALLOCIRN];
    break;
  case GET_ALLOCISEEDN:
    outflux = y[I_ALLOCISEEDN];
    break;
  case GET_NINP:
    outflux = y[I_NINP];
    break;
  ...
  case GET_VNUP:
    ...
    break;
  case GET_NRESORBL:
    outflux = y[I_NRESORBL];
    break;
  case GET_NRESORBS:
    outflux = y[I_NRESORBS];
    break;
  case GET_NRESORBR:
    outflux = y[I_NRESORBR];
    break;
  case GET_NRESORBSEED:
    outflux = y[I_NRESORBSEED];
    break;
  case GET_LTRLN:
    outflux = y[I_LTRLN];
    break;
  ...
  case GET_LTRRN:
    ...
    break;
  case GET_LTRSEEDN:
    outflux = y[I_LTRSEEDN];
    break;
  case GET_AGSTUBN:
    outflux = ag.getSTUBBLEN();
    break;
  case GET_MNUP:
    outflux = y[I_MNUP];
    break;
  ...
  case GET_CNVRTC:
    outflux = ag.getCONVRTFLXC();
    break;
  case GET_VCNVRTC:
    outflux = ag.getVCONVRTFLXC();
    break;
  case GET_SCNVRTC:
    outflux = ag.getSCONVRTFLXC();
    break;
  case GET_SLASHC:
    outflux = ag.getSLASHC();
    break;
  case GET_STANDDEADC:
    outflux = ag.getSTANDDEADC();
    break;
  case GET_STANDDEADN:
    outflux = ag.getSTANDDEADN();
    break;
  case GET_VOLAC:
    outflux = ag.getVOLAC();
    break;
  ...
  case GET_CNVRTN:
    outflux = ag.getCONVRTFLXN();
    break;
  case GET_VCNVRTN:
    outflux = ag.getVCONVRTFLXN();
    break;
  case GET_SCNVRTN:
    outflux = ag.getSCONVRTFLXN();
    break;
  case GET_SLASHN:
    outflux = ag.getSLASHN();
    break;
  case GET_NRETNT:
    outflux = ag.getNRETENT();
    break;
  case GET_NVRTNT:
    outflux = ag.getNVRETENT();
    break;
  case GET_NSRTNT:
    outflux = ag.getNSRETENT();
    break;

  case GET_AGSTUBC:
    outflux = ag.getSTUBBLEC();
    break;
  case GET_RESIDC:
    outflux = ag.getCROPRESIDUEC();
    break;

  case GET_AGPRDC:
    outflux = ag.getPROD1C();
    break;
  case GET_CLIPPINGS:
    outflux = ag.getCLIPPINGS();
    break;
  case GET_PROD10C:
    outflux = ag.getPROD10C();
    break;
  case GET_PROD100C:
    outflux = ag.getPROD100C();
    break;

  case GET_AGPRDN:
    outflux = ag.getPROD1N();
    break;
  case GET_PROD10N:
    outflux = ag.getPROD10N();
    break;
  case GET_PROD100N:
    outflux = ag.getPROD100N();
    break;
  case GET_RESIDN:
    outflux = ag.getCROPRESIDUEN();
    break;

  case GET_FRESIDC:
    outflux = ag.getFORMCROPRESIDUEC();
    break;

  case GET_AGFPRDC:
    outflux = ag.getCROPPRODC();
    break;
  case GET_PRDF10C:
    outflux = ag.getFORMPROD10C();
    break;
  case GET_PRDF100C:
    outflux = ag.getFORMPROD100C();
    break;
  case GET_AGPRDFC:
    outflux = ag.getPROD1DECAYC();
    break;
  case GET_PRD10FC:
    outflux = ag.getPROD10DECAYC();
    break;
  case GET_PRD100FC:
    outflux = ag.getPROD100DECAYC();
    break;
  case GET_TOTPRDFC:
    outflux = ag.getTOTPRODDECAYC();
    break;
  case GET_RESIDFC:
    outflux = ag.getCROPRESIDUEFLXC();
    break;

  case GET_AGFPRDN:
    outflux = ag.getCROPPRODN();
    break;
  case GET_PRDF10N:
    outflux = ag.getFORMPROD10N();
    break;
  case GET_PRDF100N:
    outflux = ag.getFORMPROD100N();
    break;
  case GET_FRESIDN:
    outflux = ag.getFORMCROPRESIDUEN();
    break;
  case GET_AGPRDFN:
    outflux = ag.getPROD1DECAYN();
    break;
  case GET_PRD10FN:
    outflux = ag.getPROD10DECAYN();
    break;
  case GET_PRD100FN:
    outflux = ag.getPROD100DECAYN();
    break;
  case GET_TOTPRDFN:
    outflux = ag.getTOTPRODDECAYN();
    break;
  case GET_RESIDFN:
    outflux = ag.getCROPRESIDUEFLXN();
    break;
...
double Ttem45::getOptionalWflx(const int &optflx)
{
  ...
  case GET_PCTP:
    ...
    break;
  case GET_VSM:
    outflux = 100.0 * y[I_VSM];
    break;

  case GET_RAIN:
    outflux = atms.getRAIN();
    break;
  case GET_SNWFAL:
    outflux = atms.getSNOWFALL();
    break;
  case GET_GDD:
    outflux = ag.getGROWDD();
    break;
  case GET_SNWINF:
    outflux = soil.getSNOWINF();
    break;
  case GET_AGIRRIG:
    outflux = y[I_AGIRRIG];
    break;
  case GET_TAIR:
    outflux = atms.getTAIR();
    break;
  case GET_TAIRD:
    outflux = atms.getTAIRD();
    break;
  case GET_TAIRN:
    outflux = atms.getTAIRN();
    break;
  case GET_NIRR:
    outflux = atms.getNIRR();
    break;
  case GET_PAR:
    outflux = atms.getPAR();
    break;
  case GET_GIRR:
    outflux = atms.getGIRR();
    break;
  case GET_CLDS:
    outflux = atms.getCLDS();
    break;
  ...
  case GET_GS:
    ...
    break;
  case GET_PESOIL:
    outflux = veg.getPESOILW();
    break;
  case GET_PECAN:
    outflux = veg.getPECANW();
    break;
  case GET_SHFLUX:
    outflux = veg.getSHFLUXW();
    break;
  case GET_SWP:
    outflux = soil.getSWP();
    break;
  case GET_VEGH:
    outflux = veg.pen.getVEGH();
    break;
  case GET_USTAR:
    outflux = veg.pen.getUSTAR();
    break;
  case GET_ZD:
    outflux = veg.pen.getZD();
    break;
  case GET_ZO:
    outflux = veg.pen.getZO();
    break;
  case GET_R_AA:
    outflux = veg.pen.getR_AA();
    break;
  case GET_R_AC:
    outflux = veg.pen.getR_AC();
    break;
  case GET_R_AS:
    outflux = veg.pen.getR_AS();
    break;
  case GET_R_SS:
    outflux = veg.pen.getR_SS();
    break;
  ...
  case GET_VAPR:
    ...
    break;
  case GET_VPDD:
    outflux = atms.getVPDD();
    break;
  case GET_VPDN:
    outflux = atms.getVPDN();
    break;

    //    case GET_AVLH2O:  outflux = (y[I_SM] - soil.getWILTPT()); break;
  case GET_AVLH2O:
    outflux = soil.getAVLH2O();
    break;
  case GET_RGRNDW:
    outflux = y[I_RGRW];
    break;
...
void Ttem45::massbal(const int &ichrt)
{
  ...
  if ((y[I_SM][ichrt] - prevy[I_SM][ichrt]) != (soil.getSNOWINF() + atms.getRAIN() + y[I_AGIRRIG][ichrt] - y[I_RPERC][ichrt] - y[I_EET][ichrt] - y[I_SPERC][ichrt]))
  {
    y[I_SPERC][ichrt] = soil.getSNOWINF() + atms.getRAIN() + y[I_AGIRRIG][ichrt] - y[I_RPERC][ichrt] - y[I_EET][ichrt] - y[I_SM][ichrt] + prevy[I_SM][ichrt];
  }

  if (y[I_SM][ichrt] <= ZERO)
  {
    y[I_SM][ichrt] = 0.001;
  }
  ...
  if (y[I_SPERC][ichrt] < ZERO)
  {
    y[I_SPERC][ichrt] = ZERO;
  }
  ...
  if (y[I_INNPP][ichrt] < y[I_NPP][ichrt])
  {
    y[I_INNPP][ichrt] = y[I_NPP][ichrt];
  }

  if (y[I_INGPP][ichrt] < y[I_GPP][ichrt])
  {
    y[I_INGPP][ichrt] = y[I_GPP][ichrt];
  }
  ...
  if (y[I_LEAFC][ichrt] - prevy[I_LEAFC][ichrt] != y[I_ALLOCLC][ichrt] - y[I_RMLEAF][ichrt] - y[I_LTRLC][ichrt])
  {
    y[I_LTRLC][ichrt] = y[I_ALLOCLC][ichrt] - y[I_RMLEAF][ichrt] - y[I_LEAFC][ichrt] + prevy[I_LEAFC][ichrt];
  }

  if (y[I_LEAFC][ichrt] < ZERO)
  {
    y[I_LEAFC][ichrt] = ZERO;
  }

  if (y[I_SAPWOODC][ichrt] - prevy[I_SAPWOODC][ichrt] != y[I_ALLOCSC][ichrt] - y[I_ALLOCHC][ichrt] - y[I_RMSAPWOOD][ichrt] - y[I_LTRSC][ichrt])
  {
    y[I_LTRSC][ichrt] = y[I_ALLOCSC][ichrt] - y[I_ALLOCHC][ichrt] - y[I_RMSAPWOOD][ichrt] - y[I_SAPWOODC][ichrt] + prevy[I_SAPWOODC][ichrt];
  }

  if (y[I_SAPWOODC][ichrt] < ZERO)
  {
    y[I_SAPWOODC][ichrt] = ZERO;
  }

  if (y[I_HEARTWOODC][ichrt] - prevy[I_HEARTWOODC][ichrt] != y[I_ALLOCHC][ichrt] - y[I_LTRHC][ichrt])
  {
    y[I_LTRHC][ichrt] = y[I_ALLOCHC][ichrt] - y[I_HEARTWOODC][ichrt] + prevy[I_HEARTWOODC][ichrt];
  }

  if (y[I_HEARTWOODC][ichrt] < ZERO)
  {
    y[I_HEARTWOODC][ichrt] = ZERO;
  }

  if (y[I_ROOTC][ichrt] - prevy[I_ROOTC][ichrt] != y[I_ALLOCRC][ichrt] - y[I_RMROOT][ichrt] - y[I_LTRRC][ichrt])
  {
    y[I_LTRRC][ichrt] = y[I_ALLOCRC][ichrt] - y[I_RMROOT][ichrt] - y[I_ROOTC][ichrt] + prevy[I_ROOTC][ichrt];
  }

  if (y[I_ROOTC][ichrt] < ZERO)
  {
    y[I_ROOTC][ichrt] = ZERO;
  }

  if (y[I_SEEDC][ichrt] - prevy[I_SEEDC][ichrt] != y[I_ALLOCSEEDC][ichrt] - y[I_RMSEED][ichrt] - y[I_LTRSEEDC][ichrt])
  {
    y[I_LTRSEEDC][ichrt] = y[I_ALLOCSEEDC][ichrt] - y[I_RMSEED][ichrt] - y[I_SEEDC][ichrt] + prevy[I_SEEDC][ichrt];
  }

  if (y[I_LABILEC][ichrt] - prevy[I_LABILEC][ichrt] != y[I_GPP][ichrt] - y[I_ALLOCLC][ichrt] - y[I_ALLOCSC][ichrt] - y[I_ALLOCRC][ichrt] -
                                                           -y[I_ALLOCSEEDC][ichrt] - y[I_RVGRW][ichrt])
  {
    y[I_RVGRW][ichrt] = y[I_GPP][ichrt] - y[I_ALLOCLC][ichrt] - y[I_ALLOCSC][ichrt] - y[I_ALLOCRC][ichrt] - y[I_ALLOCSEEDC][ichrt] - y[I_LABILEC][ichrt] + prevy[I_LABILEC][ichrt];
  }

  if (y[I_LABILEC][ichrt] < ZERO)
  {
    y[I_LABILEC][ichrt] = ZERO;
  }

  if (y[I_SOLC][ichrt] - prevy[I_SOLC][ichrt] != y[I_LTRLC][ichrt] + y[I_LTRSC][ichrt] + y[I_LTRHC][ichrt] + y[I_LTRRC][ichrt] + y[I_LTRSEEDC][ichrt] + ag.getSLASHC() - ag.getSCONVRTFLXC() - y[I_RH][ichrt] - y[I_DOCPROD][ichrt])
  {
    y[I_RH][ichrt] = y[I_LTRLC][ichrt] + y[I_LTRSC][ichrt] + y[I_LTRHC][ichrt] + y[I_LTRRC][ichrt] + y[I_LTRSEEDC][ichrt] + ag.getSLASHC() - ag.getSCONVRTFLXC() - y[I_DOCPROD][ichrt] - y[I_SOLC][ichrt] + prevy[I_SOLC][ichrt];
  }

  if (y[I_SOLC][ichrt] < ZERO)
  {
    y[I_SOLC][ichrt] = ZERO;
  }
  ...
  if (y[I_VNUP][ichrt] < ZERO)
  {
    y[I_VNUP][ichrt] = ZERO;
  }

  if (y[I_INNUP][ichrt] < y[I_VNUP][ichrt])
  {
    y[I_INNUP][ichrt] = y[I_VNUP][ichrt];
  }

  // DWK modified the following conditions for checking the mass
  //   balance on STON on 0020401

  if (y[I_LABILEN][ichrt] - prevy[I_LABILEN][ichrt] != y[I_VNUP][ichrt] + y[I_NRESORBL][ichrt] + y[I_NRESORBS][ichrt] + y[I_NRESORBR][ichrt] + y[I_NRESORBSEED][ichrt] + y[I_NFIXS][ichrt] - y[I_ALLOCLN][ichrt] - y[I_ALLOCSN][ichrt] - y[I_ALLOCRN][ichrt] - y[I_ALLOCSEEDN][ichrt])
  {
    y[I_NRESORBL][ichrt] = y[I_ALLOCLN][ichrt] + y[I_ALLOCSN][ichrt] + y[I_ALLOCRN][ichrt] + y[I_ALLOCSEEDN][ichrt] + y[I_NFIXS][ichrt] - y[I_VNUP][ichrt] + y[I_LABILEN][ichrt] - prevy[I_LABILEN][ichrt] - y[I_NRESORBS][ichrt] - y[I_NRESORBR][ichrt] - y[I_NRESORBSEED][ichrt];
  }

  //  if(veg.cmnt == 1) {y[I_NRESORBL] = 0.0;}

  if (y[I_LABILEN][ichrt] < ZERO)
  {
    y[I_LABILEN][ichrt] = ZERO;
  }

  if (y[I_NRESORBL][ichrt] < ZERO)
  {
    y[I_NRESORBL][ichrt] = ZERO;
  }

  if (y[I_LEAFN][ichrt] - prevy[I_LEAFN][ichrt] != y[I_ALLOCLN][ichrt] - y[I_NRESORBL][ichrt] - y[I_LTRLN][ichrt])
  {
  ...
  if (y[I_LEAFN][ichrt] < ZERO)
  {
    y[I_LEAFN][ichrt] = ZERO;
  }

  if (y[I_SAPWOODN][ichrt] - prevy[I_SAPWOODN][ichrt] != y[I_ALLOCSN][ichrt] - y[I_ALLOCHN][ichrt] - y[I_NRESORBS][ichrt] - y[I_LTRSN][ichrt])
  {
    y[I_LTRSN][ichrt] = y[I_ALLOCSN][ichrt] - y[I_ALLOCHN][ichrt] - y[I_NRESORBS][ichrt] - y[I_SAPWOODN][ichrt] + prevy[I_SAPWOODN][ichrt];
  }

  if (y[I_SAPWOODN][ichrt] < ZERO)
  {
    y[I_SAPWOODN][ichrt] = ZERO;
  }

  if (y[I_HEARTWOODN][ichrt] - prevy[I_HEARTWOODN][ichrt] != y[I_ALLOCHN][ichrt] - y[I_LTRHN][ichrt])
  {
    y[I_LTRHN][ichrt] = y[I_ALLOCHN][ichrt] - y[I_HEARTWOODN][ichrt] + prevy[I_HEARTWOODN][ichrt];
  }

  if (y[I_HEARTWOODN][ichrt] < ZERO)
  {
  ...
  if (y[I_ROOTN][ichrt] < ZERO)
  {
    y[I_ROOTN][ichrt] = ZERO;
  }

  if (y[I_SEEDN][ichrt] - prevy[I_SEEDN][ichrt] != y[I_ALLOCSEEDN][ichrt] - y[I_NRESORBSEED][ichrt] - y[I_LTRSEEDN][ichrt])
  {
    y[I_LTRSEEDN][ichrt] = y[I_ALLOCSEEDN][ichrt] - y[I_NRESORBSEED][ichrt] - y[I_SEEDN][ichrt] + prevy[I_SEEDN][ichrt];
  }

  if (y[I_SEEDN][ichrt] < ZERO)
  {
    y[I_SEEDN][ichrt] = ZERO;
  }

#ifdef OPENN
  if (y[I_SOLN][ichrt] - prevy[I_SOLN][ichrt] != y[I_LTRLN][ichrt] + y[I_LTRSN][ichrt] + y[I_LTRHN][ichrt] + y[I_LTRRN][ichrt] + y[I_LTRSEEDN][ichrt] + ag.getSLASHN() + y[I_NFIXN][ichrt] - y[I_DONPROD][ichrt] - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_NMIN][ichrt])
  {
    y[I_NMIN][ichrt] = y[I_LTRLN][ichrt] + y[I_LTRSN][ichrt] + y[I_LTRHN][ichrt] + y[I_LTRRN][ichrt] + y[I_LTRSEEDN][ichrt] + ag.getSLASHN() + y[I_NFIXN][ichrt] - y[I_DONPROD][ichrt] - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_SOLN][ichrt] + prevy[I_SOLN][ichrt];
  }

  //  NOTINSHREE
  if (y[I_SOLN][ichrt] < ZERO)
  {
    y[I_SOLN][ichrt] = ZERO;
  }
  ...
  {
    y[I_NMIN][ichrt] = y[I_LTRLN][ichrt] + y[I_LTRSN][ichrt] + y[I_LTRHN][ichrt] + y[I_LTRRN][ichrt] + y[I_LTRSEEDN][ichrt] + ag.getSLASHN() - ag.getSCONVRTFLXN() - ag.getNSRETENT() - y[I_SOLN][ichrt] + prevy[I_SOLN][ichrt];
  }
  ...
  if (y[I_AGFRTN][ichrt] < ZERO)
  {
    y[I_AGFRTN][ichrt] = ZERO;
  }
  ...
  if (y[I_NINP][ichrt] < ZERO)
  {
    y[I_NINP][ichrt] = ZERO;
  }

  if (y[I_NLST][ichrt] < ZERO)
  {
    y[I_NLST][ichrt] = ZERO;
  }
  ...
  {
    //    y[I_NLST] = ZERO;
    y[I_NINP][ichrt] = y[I_NLST][ichrt] - y[I_NMIN][ichrt] - ag.getVOLAN() + y[I_VNUP][ichrt] + y[I_AVLN][ichrt] - prevy[I_AVLN][ichrt];
  }
  ...
  {
    //    y[I_NINP] = ZERO;
    y[I_NLST][ichrt] = y[I_NINP][ichrt] + y[I_NMIN][ichrt] + ag.getVOLAN() - y[I_VNUP][ichrt] - y[I_AVLN][ichrt] + prevy[I_AVLN][ichrt];
  }
};
                             ...
                             ofstream &rflog1)
{
  ...
  if (ag.state == 0 || (ag.state > 0 && disturbflag > 0 && pdm < (disturbmonth - 1)))
  {
...
void Ttem45::pcdisplayMonth(const int &dyr, const int &pdm)
{
  ...
  for (iout = 0; iout < ESY; ++iout)
  {
    ...
    if (outevar[iout] > outevarmax[iout])
    {
      outevarmax[iout] = outevar[iout];
    }
    if (outevar[iout] < outevarmin[iout])
    {
      outevarmin[iout] = outevar[iout];
    }
  }
  ...
  for (iout = 0; iout < WSY; ++iout)
  {
    ...
    if (outwvar[iout] > outwvarmax[iout])
    {
      outwvarmax[iout] = outwvar[iout];
    }
    if (outwvar[iout] < outwvarmin[iout])
    {
      outwvarmin[iout] = outwvar[iout];
    }
  }
                  ...
                  const double &nmax_grow)
{
  ...
  if (calc_dz1_flag != 0)
  {
    delta(pdm, pdyr, nmax_grow, pstate, dz1);
                      ...
                      ofstream &rflog1)
{
  ...
  avgfac = 1.0 / (12.0 * (veg.getTAULEAF(veg.cmnt) + veg.getTAUSAPWOOD(veg.cmnt) + veg.getTAUROOT(veg.cmnt)) / 3.0);
  avgfac = exp(-avgfac);
  if (pdm == 0)
  {
    mxeet = 0.0;
  ...
  if (0 == pdm)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          microbe.setKD((ag.getKD() * y[I_SOLC][ichrt] / ag.getNATSOIL()));
        }
        else
        {
...
// Get environmental conditions for month "dm"
  ...
  {
    ag.setGROWDD(ag.getGROWDD() + ((atms.getTAIR() - ag.getGDDMIN(ag.cmnt)) * atms.getNDAYS(pdm)));
  }
  else
  {
    ...
    if (1 == ag.state && ag.getGROWDD() > ag.getGDDSEED(ag.cmnt) && atms.getTAIRN() <= ag.getTKILL(ag.cmnt))
    {
#ifdef DEBUG_CTEM
      move(DEBUG_ROW, 1);
    ...
    if (0 == ag.getISPERENNIAL(ag.cmnt) && atms.getTAIRN() <= ag.getTKILL(ag.cmnt))
    {
      ag.setGROWDD(ZERO);
    }
  }
  ...
  if (blackhol != 0)
  {
    if (0 == initFlag || pdyr < 0 || pdyr >= MAXRTIME)
    {
      qualcon[0] = 10;
    }
    else
...
//   soil.setNINPUT( ( ag.fertn) );
  ...
  ag.setCFLUX((nep - ag.getCONVRTFLXC() - ag.getCROPRESIDUEFLXC()));
  ...
  ag.setTOTEC((veg.getVEGC() + y[I_SOLC][ichrt]));
...
// NOTINSHREE
  ...
  soil.setNLOST((soil.getNLOST()
                 //                  + nprod
                 //                  + y[I_LCHDON]
                 + soil.getLCHDON() + ag.getCONVRTFLXN() + ag.getCROPRESIDUEFLXN()));
...
#else
  soil.setNLOST((soil.getNLOST() + ag.getCONVRTFLXN() + ag.getCROPRESIDUEFLXN()));
  soil.setNINPUT((ag.fertn));
#endif
  ...
  if (mxeet < soil.getEET())
  {
    mxeet = soil.getEET();
  }

  if (pdyr == (int)tauavg && pdm == CYCLE - 1)
  {
    yearSummaryExtrapolate();
  }

  if (pdm == CYCLE - 1)
  {
    if ((veg.yralloclc + veg.yrallocsc + veg.yrallocrc + veg.yrallocseedc - veg.yrrmleaf - veg.yrrmsapwood - veg.yrrmroot) != ZERO)
    {
      veg.yrpleaf = (veg.yralloclc - veg.yrrmleaf) /
                    (veg.yralloclc + veg.yrallocsc + veg.yrallocrc + veg.yrallocseedc - veg.yrrmleaf - veg.yrrmsapwood - veg.yrrmroot);
  ...
  if (atms.getTAIRN() < ag.getTKILL(ag.cmnt))
  {
    ag.setGROWDD(ZERO);
  }
  ag.setFROSTFLAG(0);
  ...
  mdemandn = y[I_ALLOCLN][ichrt] + y[I_ALLOCSN][ichrt] + y[I_ALLOCRN][ichrt] + y[I_ALLOCSEEDN][ichrt] - y[I_NRESORBL][ichrt] - y[I_NRESORBS][ichrt] - y[I_NRESORBR][ichrt] - y[I_NRESORBSEED][ichrt];
  ...
  if ((CYCLE - 1) == pdm)
  {
    ...
    if (1 == baseline)
    {
      ...
      if ((soil.yrorgc / microbe.getCNSOIL(veg.cmnt) > soil.yrorgn) && (y[I_SOLC][ichrt] / microbe.getCNSOIL(veg.cmnt) > y[I_SOLN][ichrt]))
      {
      ...
      else if ((soil.yrorgc / microbe.getCNSOIL(veg.cmnt) < soil.yrorgn) && (y[I_SOLC][ichrt] / microbe.getCNSOIL(veg.cmnt) < y[I_SOLN][ichrt]))
      {
                            ...
                            const double &soilneq)
{
  ...
  {
    if (0 == nfeed && 0 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun) && (ctol >= fabs(veg.yrnpp - veg.yrltrc)))
    {
      return 1;
    }

    if (0 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
        ...
        && (ctol >= fabs((veg.getVEGC() + y[I_SOLC][ichrt]) -
                         (vegceq + soilceq))) &&
        (ctol >= fabs((veg.getVEGC() - vegceq))) && (ctol >= fabs((y[I_SOLC][ichrt] - soilceq))))
    {
      return 1;
    }
    ...
    if (ag.state == 0)
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ntol >= fabs(soil.yrnin - soil.yrnlost)) && (ntol >= fabs((veg.getVEGN() + y[I_SOLN][ichrt]) - (vegneq + soilneq))) && (ntol >= fabs((veg.getVEGN() - vegneq))) && (ntol >= fabs((y[I_SOLN][ichrt] - soilneq)))
    ...
    else if (ag.state == 1)
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ntol >= (veg.getVEGN() + y[I_SOLN][ichrt]) -
                          (vegneq + soilneq)) &&
          (ntol >= (veg.getVEGN() - vegneq)) && (ntol >= (y[I_SOLN][ichrt] - soilneq))

          && (ctol >= (veg.getVEGC() + y[I_SOLC][ichrt]) -
                          (vegceq + soilceq)) &&
          (ctol >= (veg.getVEGC() - vegceq)) && (ctol >= (y[I_SOLC][ichrt] - soilceq)) && (fabs(yrnep - ag.yrformPROD1C) <= 2.0))
    ...
    else
    {
      if (1 == nfeed && 1 == rheqflag && wtol >= fabs(atms.yrrain + atms.yrsnowfall - soil.yreet - soil.yrrrun - soil.yrsrun)
          ...
          && (ctol >= (veg.getVEGC() + y[I_SOLC][ichrt]) -
                          (vegceq + soilceq)) &&
          (ctol >= (veg.getVEGC() - vegceq)) && (ctol >= (y[I_SOLC][ichrt] - soilceq)))
