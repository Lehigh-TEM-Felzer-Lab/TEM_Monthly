 /**************************************************************
XTEM45_disturb_aggregate.CPP - Extrapolation version of the Terrestrial Ecosystem
               Model Version 4.5
****************************************************************
...
#include "telm45_disturb_aggregate.h"          // Telm45 Class
...
// BSF move temwritepred outside cohort loop
      if( 1 == equil )
      {
...
//  cout << "cohort_here = " << ichrt << " " << telmnt[0].cohort[ichrt].cmnt << " " << telmnt[0].cohort[ichrt].agcmnt  << endl;
    ...
    for( dm = 0; dm < CYCLE; ++dm )
    {
      ...
      telmnt[0].updateTEMmonth( equil,
                                ...
                                ichrt,
                                rflog1 );
      cout << "diag4 = " << telmnt[0].totchrtarea[9][0] << " " << telmnt[0].totchrtarea[10][0] << endl; 
    } // end of CYCLE loop
