                     ...
                     const int &pdm)
{
  ...
  if (lon > -90.0 && lon < -55.0 && lat > 10.0 && lat < 90.0 && "NAMERICA" == contnent)
  {
  ...
  else if (lon > -124.0 && lon < -112.0 && lat > 47.0 && lat < 55.0 && "NAMERICA" == contnent)
  {
  ...
  else if (lon > -180.0 && lon < -123.0 && lat > 53.0 && lat < 90.0 && "NAMERICA" == contnent)
  {
    //  Alaska and North
    tmin = 6.;
    tmax = 17.;
  ...
  else if (lon > -180.0 && lon < -90.0 && lat > 10.0 && lat < 90.0 && "NAMERICA" == contnent)
  {
    //  West North America
    tmin = 6.;
    tmax = 16.;
  ...
  else if (lon > -15.0 && lon < 180.0 && lat > 10.0 && lat < 90.0 && ("EUROPE" == contnent || "ASIA" == contnent))
  {
    //  Eur-Asia
    tmin = 5.;
    tmax = 15.;
  ...
  if (0 == pdm || 1 == pdm || 2 == pdm || 3 == pdm || 10 == pdm || 11 == pdm || -999 == itmp)
  {
    d40 = 0.0;
  }
  else
  ...
  */
  ...
  for (day = 0; day < ndays[pdm]; ++day)
  {
    ...
    for (hour = 0; hour < 24; ++hour)
    {
      ...
      sotd = 1 - (0.016729 * cos(0.9856 * (psumday - 4.0) * pi / 180.0));
