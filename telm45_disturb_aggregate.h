/* **************************************************************
*****************************************************************
TELM45_disturb_aggregate.H - Determines the interface among CLM, LCLUC and TEM
             modules_aggregate
...
#ifndef TELM45_DISTURB_AGGREGATE_H
#define TELM45_DISTURB_AGGREGATE_H
...
#include "ttemdat45a_aggregate.h"  //Telm45 uses the Temdat45 class
...
//     vector<string> predstr;
     ...
     double output[NUMTEM][CYCLE][NUMVEG];
     double totchrtarea[NUMVEG][CYCLE];
