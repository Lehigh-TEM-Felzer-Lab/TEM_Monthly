/* **************************************************************
*****************************************************************
PENMON45_equil.CPP - object computes EET using Penman-Monteith
...

{
  ...
  */
  ...
  ecanmmmo = ndays[dm] * (1.0 - exp(-0.005 * precip)) * (1.0 - exp(-kext[pdcmnt] * lai)) * maxh2ocanopy * lai;
