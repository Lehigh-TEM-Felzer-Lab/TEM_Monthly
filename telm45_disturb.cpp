...
void Telm45::outputTEMmonth(const int &pdm)
{
  ...
  if (0 == tem.ag.state)
  {
    ...
    output[tem.I_NATVEGC][pdm] = tem.getY(tem.I_LEAFC) + tem.getY(tem.I_SAPWOODC) + tem.getY(tem.I_HEARTWOODC) + tem.getY(tem.I_ROOTC) + tem.getY(tem.I_LABILEC);

    output[tem.I_CROPN][pdm] = ZERO;
    output[tem.I_NATVEGN][pdm] = tem.getY(tem.I_LEAFN) + tem.getY(tem.I_SAPWOODN) + tem.getY(tem.I_HEARTWOODN) + tem.getY(tem.I_ROOTN) + tem.getY(tem.I_LABILEN);
    ...
    output[tem.I_NATLTRN][pdm] = tem.getY(tem.I_LTRLN) + tem.getY(tem.I_LTRSN) + tem.getY(tem.I_LTRHN) + tem.getY(tem.I_LTRRN);
  }
  else
  {
    output[tem.I_CROPC][pdm] = tem.getY(tem.I_LEAFC) + tem.getY(tem.I_SAPWOODC) + tem.getY(tem.I_HEARTWOODC) + tem.getY(tem.I_ROOTC) + tem.getY(tem.I_LABILEC);
    output[tem.I_NATVEGC][pdm] = ZERO;

    output[tem.I_CROPN][pdm] = tem.getY(tem.I_LEAFN) + tem.getY(tem.I_SAPWOODN) + tem.getY(tem.I_HEARTWOODN) + tem.getY(tem.I_ROOTN) + tem.getY(tem.I_LABILEN);
    output[tem.I_NATVEGN][pdm] = ZERO;

    output[tem.I_CSTRN][pdm] = tem.getY(tem.I_LEAFN) + tem.getY(tem.I_SAPWOODN) + tem.getY(tem.I_HEARTWOODN) + tem.getY(tem.I_ROOTN);
    output[tem.I_NATSTRN][pdm] = ZERO;
    ...
    output[tem.I_AGLTRC][pdm] = tem.getY(tem.I_LTRLC) + tem.getY(tem.I_LTRSC) + tem.getY(tem.I_LTRHC) + tem.getY(tem.I_LTRRC);
    ...
    output[tem.I_AGLTRN][pdm] = tem.getY(tem.I_LTRLN) + tem.getY(tem.I_LTRSN) + tem.getY(tem.I_LTRHN) + tem.getY(tem.I_LTRRN);
